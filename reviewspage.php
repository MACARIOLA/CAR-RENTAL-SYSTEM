                ...
                <div class="row align-items-end ">
                    <div class="col-lg-5">
                        <div class="intro">
                            ...
                            <div class="custom-breadcrumbs"><a href="home.html">Home</a> <span class="mx-2">/</span>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 mr-auto">
                        ...
                        <br>
                        <p class="text-justify">Join the community of voices shaping the narrative of Imperial Drive,
                            where your insights contribute to our ongoing pursuit of excellence. It's not just a review
                            section; it's a testament to the genuine experiences that define our commitment to providing
                            you with the finest car rental services.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-7 text-center mb-5">
                        ...
                        <p>Feel free to express your thoughts and contribute to the ongoing pursuit of excellence at
                            Imperial Drive by leaving a review. Your insights play a crucial role in shaping the quality
                            of our services.</p>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 mb-4 mb-md-0">
                    ...
                    <p class="mb-0 opa-7">Ready to hit the road? Unleash your journey! Get behind the wheel of your
