            ...
            <span class="d-inline-block d-lg-none"><a href="#" class=" site-menu-toggle js-menu-toggle py-5 "><span class="icon-menu h3 text-black"></span></a></span>
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  ...
                  <li><a href="cars.php" class="nav-link zoom-out-image"><b>Cars</b></a></li>
          ...
          <div class="row align-items-end ">
            <div class="col-lg-5">
              <div class="intro">
                ...
                <div class="custom-breadcrumbs"><a href="home.php">Home</a> <span class="mx-2">/</span><strong>Services</strong></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="car-list-card  listing d-block  align-items-stretch">
            <div class="listing-img h-100 mr-4">
              <img src="images/car_6.jpg" alt="Image" class="img-fluid zoom-out-image">
            </div>
            <div class="listing-contents h-100">
              <h3>Mitsubishi Pajero</h3>
              <div class="rent-price">
                <strong>₱820.00</strong><span class="mx-1">/</span>day
              </div>
              <div class="d-block d-md-flex mb-3 border-bottom pb-3"></div>
              <div class="text-center zoom-out-image">
                <p><a href="cars.php" class="btn btn-primary btn-sm">Details</a></p>
              </div>
            </div>
          </div>
        </div>
